export default function PrivacyPolicy() {
    ...
    <main className="max-w-[90%] mx-auto mt-28 mb-10 lg:mb-20 lg:mt-40 lg:max-w-[70%] space-y-5">
            ...
            <section className="space-y-4 text-sm">
                <h2 className="font-semibold text-lg">1. Quem somos</h2>
                <p>
                ...
                <h2 className="font-semibold text-lg">2. Dados que coletamos</h2>
                ...
                <h2 className="font-semibold text-lg">4. Compartilhamento de dados</h2>
                <p>
                ...
                <h2 className="font-semibold text-lg">6. Retenção e eliminação</h2>
                <p>
                ...
                <h2 className="font-semibold text-lg">7. Seus direitos</h2>
                <p>
                ...
                <h2 className="font-semibold text-lg">8. Alterações nesta política</h2>
                <p>
                ...
                <h2 className="font-semibold text-lg">9. Contato</h2>
                <p>
