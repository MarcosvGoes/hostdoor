    ...
    return (
        <div className="grid py-10 max-w-[90%] space-y-20 mx-auto">
            <div className="space-y-5">
                <h1 className="text-3xl font-semibold">Sobre a Dommi</h1>
                <div className="text-base space-y-5">
                    <p>A Dommi nasceu para atender pessoas que querem alugar um imóvel de forma prática, segura e sem pagar taxas abusivas às imobiliárias tradicionais.</p>
            ...
            <div className="space-y-5">
                ...
                <div className="text-base space-y-5">
                    <p>Na Dommi, você conta com suporte completo do início ao fim da sua estadia no imóvel escolhido.</p>
            ...
            <div className="space-y-5">
                ...
                <div className="text-base space-y-5">
                    <p>A Dommi oferece suporte completo para que você alugue seus imóveis com a segurança de uma imobiliária, mas com um custo muito mais acessível.</p>
                    <p>Cadastre-se em nosso <a href="https://dommi-rent.vercel.app" target="_blank" className="hover:cursor-pointer"><strong>app para proprietários</strong></a>, preencha seus dados e registre seu imóvel. Ele será automaticamente exibido em nosso catálogo.</p>
