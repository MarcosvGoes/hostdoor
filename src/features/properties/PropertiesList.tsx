  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
      {properties.map((property) => (
        <Card key={property.id} className="flex cursor-pointer flex-col p-0 gap-0" onClick={() => router.push(`/catalog/${property.id}`)}>
          ...
          <div className="p-4">
            <h3 className="font-semibold text-base mb-2">{property.title}</h3>
